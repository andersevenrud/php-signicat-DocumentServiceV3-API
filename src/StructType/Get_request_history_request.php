...
/**
 * This class stands for get-request-history-request StructType
 * @subpackage Structs
 */
class Get_request_history_request extends AbstractStructBase
{
    /**
     * The service
     * @var string
    ...
    public $task_id;
    /**
     * Constructor method for get-request-history-request
     * @uses Get_request_history_request::setService()
     * @uses Get_request_history_request::setPassword()
     * @uses Get_request_history_request::setRequest_id()
     * @uses Get_request_history_request::setTask_id()
     ...
     * Set service value
     * @param string $service
     * @return \Signicat\DocumentServiceV3_API\StructType\Get_request_history_request
     */
