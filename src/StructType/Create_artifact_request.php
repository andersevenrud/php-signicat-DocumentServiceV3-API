...
/**
 * This class stands for create-artifact-request StructType
 * @subpackage Structs
 */
class Create_artifact_request extends AbstractStructBase
{
    /**
     * The service
     * @var string
    ...
    public $task_id;
    /**
     * Constructor method for create-artifact-request
     * @uses Create_artifact_request::setService()
     * @uses Create_artifact_request::setPassword()
     * @uses Create_artifact_request::setRequest_id()
     * @uses Create_artifact_request::setTask_id()
     ...
     * Set service value
     * @param string $service
     * @return \Signicat\DocumentServiceV3_API\StructType\Create_artifact_request
     */
