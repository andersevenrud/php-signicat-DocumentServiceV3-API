...
/**
 * This class stands for disable-task-request StructType
 * @subpackage Structs
 */
class Disable_task_request extends AbstractStructBase
{
    /**
     * The service
     * @var string
    ...
    public $task_id;
    /**
     * Constructor method for disable-task-request
     * @uses Disable_task_request::setService()
     * @uses Disable_task_request::setPassword()
     * @uses Disable_task_request::setRequest_id()
     * @uses Disable_task_request::setTask_id()
     ...
     * Set service value
     * @param string $service
     * @return \Signicat\DocumentServiceV3_API\StructType\Disable_task_request
     */
